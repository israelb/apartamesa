...
class install_nginx {
  ...
  nginx::resource::vhost { 'apartamesa.dev':
    ensure => present,
...
package { ['libxml2', 'libxml2-dev', 'libxslt1-dev', 'libxslt-dev', 'openssl', 'libreadline6', 'libreadline6-dev', 'zlib1g', 'zlib1g-dev', 'libssl-dev']:
  ensure => installed
}
